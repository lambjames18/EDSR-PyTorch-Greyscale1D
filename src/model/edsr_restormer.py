...
def make_model(args, parent=False):
    return EDSR_Restormer(args)

class EDSR_Restormer(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        super(EDSR_Restormer, self).__init__()

        self.EDSR = EDSR(args)
        self.Restormer = Restormer(inp_channels=args.n_colors, out_channels=args.n_colors, dim=48)

        # Freeze EDSR
        for param in self.EDSR.parameters():
...
class Restormer(nn.Module):
    ...
    def forward(self, inp_img):
        ...
        print("OUT", out_dec_level1.shape)
